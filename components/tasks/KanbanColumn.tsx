              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    onKeyDown={handleKeyDown}
                    placeholder="Est. (min)"
                    className="w-16 h-7 px-2 rounded-lg bg-white/[0.04] border border-white/[0.08] text-xs text-white placeholder:text-[#8888AA]/60 focus:outline-none focus:ring-1 focus:ring-[#FF4533]"
                  />
                </div>
